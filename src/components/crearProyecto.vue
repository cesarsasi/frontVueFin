...
<div class="container">
    ...
    <form>
        ...
        <div>
            ...
            <input type="text" id="email" v-model="newProyecto.descripcion">
        </div>
        <div>
        ...
        <div>
            <label for="name">Presupuesto disponible</label>
            <input type="text" id="phone" v-model="newProyecto.presupuesto">
        </div>
        <div>
            <label for="name">Tiempo Estimado</label>
            <input type="text" id="phone" v-model="newProyecto.tiempoEstimado">
        </div>
        <div>
